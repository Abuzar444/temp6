...
export const validateCourseInput = withValidationErrors([
  ...
  // body('name').notEmpty().withMessage('Please provide course name').trim(),
  // body('instructor')
  //   .notEmpty()
  //   .withMessage('Please provide instructor name')
  //   .trim(),
  // body('description')
  //   .notEmpty()
  //   .withMessage('Please provide course description')
  //   .trim(),
  ...
  // body('duration')
  //   .notEmpty()
  //   .withMessage('Please provide course duration')
  //   .trim(),
  // body('schedule')
  //   .notEmpty()
  //   .withMessage('Please provide course schedule')
  //   .trim(),
...
export const validateIdParams = withValidationErrors([
  param('id').custom(async (idValue, { req }) => {
    ...
    const course = await Course.findById(idValue)
    // IF THE ID IS VALID BUT MONGO DB CANNOT FIND THAT DOCUMENT , EG - THE DOCUMENT MAY HAVE BEEN DELETED
    if (!course) {
      throw new NotFoundError(`No course with id ${idValue} found`)
    }
